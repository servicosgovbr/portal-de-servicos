...
/**
 * <p>Java class for servicosType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="servico" type="{}servicoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ServicosType {
     ...
     * 
     */
    public List<ServicoType> getServico() {
        if (servico == null) {
            servico = new ArrayList<ServicoType>();
        }
        return this.servico;
    }
