...
Quaisquer transações de escrita (modificação ou remoção) iniciadas por um usuário devem conter informações de auditoria nos logs. Mais detalhes na seção [Segurança](#seguran%C3%A7a).
...
Devem ser seguidas as recomendações descritas na última versão da [Cartilha de Usabilidade do Governo Eletrônico](http://www.governoeletronico.gov.br/acoes-e-projetos/padroes-brasil-e-gov/cartilha-de-usabilidade).
